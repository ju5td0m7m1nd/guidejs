...
var RecordBtn = function (_React$Component) {
  ...
  _createClass(RecordBtn, [{
    ...
    value: function render() {
      ...
      recordBtnStyle = this.state.open ? Object.assign({}, recordBtnStyle, { 'bottom': this.state.openPos + '%' }) : recordBtnStyle;
...
var PlayBtn = function (_React$Component2) {
  ...
  _createClass(PlayBtn, [{
    ...
    value: function render() {
      ...
      playBtnStyle = this.state.open ? Object.assign({}, playBtnStyle, { 'bottom': this.state.openPos + '%' }) : playBtnStyle;
      return _react2.default.createElement(
        'div',
