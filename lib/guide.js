  ...
  _createClass(Guide, [{
    ...
    value: function componentDidMount() {
      ...
      if (this.props.mode !== 'dev') {
        ...
        this._XMLReq('GET', '/api/guide').then(function (res) {
          console.log(res);
          _this2.actionLog = JSON.parse(res);
        }).then(function (err) {
          //console.log("FAILED TO READ");
        });
      }
      var all = document.body.getElementsByTagName("*");
      Object.keys(all).map(function (item, key) {
        try {
          var classString = all[item].className || "";
          var newClass = classString.concat(' guidetag-' + item + 'ytuswbu');
    ...
    */
    ...
    value: function _handleClickEvent(e) {
      var target = e.target.className.split('guidetag-')[1].split('ytuswbu')[0];
    ...
    value: function _replay() {
      ...
      for (var key in this.actionLog) {
        ...
        var tagNum = action[Object.keys(action)[0]][0];
        var targetDOM = document.getElementsByClassName('guidetag-' + tagNum + 'ytuswbu')[0];
    ...
    value: function render() {
      ...
      var recordBtn = !this.state.record ? _react2.default.createElement(_button.RecordBtn, _extends({}, this.props, { ref: 'recordBtn', handleRecord: this._startRecord })) : _react2.default.createElement(_button.RecordBtn, _extends({}, this.props, { ref: 'recordBtn', handleRecord: this._stopRecord }));
